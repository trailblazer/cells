...
module ApplicationTests
  class RouterTest < ActionController::TestCase
    ...
    describe "A Rails app" do
      it "pass url_helpers to the cell instance" do
      ...
      it "delegate #url_options to the parent_controller" do
      ...
      it "allow cells to use *_url helpers when mixing in AC::UrlFor" do
        get "promote"
        assert_response :success
        assert_equal "Find me at <a href=\"http://test.host/musicians\">vd.com</a>\n", @response.body
      end

      it "allow cells to use #config" do
        BassistCell.class_eval do
