...
class PublicTest < Minitest::Spec
  ...
  it { _(Cell::ViewModel.cell("public_test/song")).must_be_instance_of SongCell }
  it { _(Cell::ViewModel.cell(PublicTest::SongCell)).must_be_instance_of SongCell }

  # Concept.cell simply camelizes the string before constantizing.
  it { _(Cell::Concept.cell("public_test/songs")).must_be_instance_of Songs }

  it { _(Cell::Concept.cell(PublicTest::Songs)).must_be_instance_of Songs }

  # ViewModel.cell passes options to cell.
  it { _(Cell::ViewModel.cell("public_test/song", Object, genre: "Metal").initialize_args).must_equal [Object, {genre:"Metal"}] }

  # ViewModel.cell(collection: []) renders cells.
  it { _(Cell::ViewModel.cell("public_test/song", collection: [Object, Module]).to_s).must_equal '[Object, {}][Module, {}]' }

  # DISCUSS: should cell.() be the default?
  # ViewModel.cell(collection: []) renders cells with custom join.
  it do
    Gem::Deprecate::skip_during do
      _(Cell::ViewModel.cell("public_test/song", collection: [Object, Module]).join('<br/>') do |cell|
          cell.()
  ...
  it do
    Gem::Deprecate::skip_during do
      _(Cell::ViewModel.cell("public_test/song", collection: [Object, Module], method: :detail).to_s).must_equal '* [Object, {}]* [Module, {}]'
    end
  end

  # ViewModel.cell(collection: []).() invokes #show.
  it { _(Cell::ViewModel.cell("public_test/song", collection: [Object, Module]).()).must_equal '[Object, {}][Module, {}]' }

  # ViewModel.cell(collection: []).(:detail) invokes #detail instead of #show.
  it { _(Cell::ViewModel.cell("public_test/song", collection: [Object, Module]).(:detail)).must_equal '* [Object, {}]* [Module, {}]' }
  ...
  it do
    _(Cell::ViewModel.cell("public_test/song", collection: [Object, Module]).join do |cell, i|
