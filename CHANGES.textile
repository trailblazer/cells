h2. 3.5.1
  * Caching.cache_key_for now uses @ActiveSupport::Cache.expand_cache_key@ and thus a key which used to be like @"cells/director/count/a=1/b=2"@ now is @cells/director/count/a=1&b=2@. Be warned that this might break your home-made cache expiry.
  * Controller#expire_cell_state now expects the cell class as first arg, as in @expire_cell_state(DirectorCell, :count)@
